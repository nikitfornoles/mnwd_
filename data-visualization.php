      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="data-visualization.php" class="active"><i class="fa fa-bar-chart fa-fw"></i>Data Visualization</a></li>
            <li><a href="maps.php"><i class="fa fa-map-marker fa-fw"></i>Maps</a></li>
            <li><a href="manage-users.php"><i class="fa fa-users fa-fw"></i>Manage Staffs</a></li>
